...
export type TextShadows = Pick<TextStyle, 'textShadowColor' | 'textShadowOffset' | 'textShadowRadius'>;
type OnlyAllowThemeValues = 'always' | 'never';
type FontWeight = 'normal' | 'bold' | '100' | '200' | '300' | '400' | '500' | '600' | '700' | '800' | '900' | 'normal';
...
export interface DripsyBaseTheme extends Omit<BaseThemeWithNativeStyles, 'fonts' | 'shadows' | 'fontWeights'> {
    /**
    ...
    types?: {
         ...
         *
         */
        onlyAllowThemeValues?: OnlyAllowThemeValues | {
...
export interface DripsyFinalTheme extends Omit<DripsyBaseTheme, keyof DripsyCustomTheme>, DripsyCustomTheme {
}
export type DripsyThemeWithoutIgnoredKeys<Theme = DripsyCustomTheme> = Omit<Theme, keyof Pick<DripsyBaseTheme, 'breakpoints' | 'customFonts' | 'useBodyStyles' | 'useLocalStorage' | 'useCustomProperties' | 'useColorSchemeMediaQuery' | 'types' | 'initialColorModeName' | 'useBorderBox'>>;
export {};
