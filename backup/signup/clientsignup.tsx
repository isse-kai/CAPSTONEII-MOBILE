...
//       setErrorMessage(
//         "You must accept Privacy Policy, Policy Agreement, and Non-Disclosure Agreement.",
//       );
//       return;
//     }
...
//     if (!API_URL) {
//       setErrorMessage(
//         "Missing EXPO_PUBLIC_API_URL. Set it to your backend IP (not localhost).",
//       );
//       return;
//     }
...
//       await axios.post(`${API_URL}/auth/start`, {
...
//       setOtpInfo("We sent a 6-digit code to your email. Enter it to verify.");
//       setOtpOpen(true);
//     } catch (e: any) {
//       const msg =
...
//       setOtpInfo("OTP resent. Please check inbox/spam.");
//     } catch (e: any) {
//       const msg =
//         e?.response?.data?.detail ||
//         e?.response?.data?.error ||
...
//                   >
//                     <Text
//                       style={{ fontSize: 16, color: sex ? "#000" : "#999" }}
//                     >
//                       {sex || "Select sex"}
//                     </Text>
//                     <Ionicons
...
//                         style={{
//                           fontSize: 12,
//                           color: passwordRequirements.length(password)
//                             ? "#16a34a"
//                             : "#ef4444",
//                         }}
//                       >
...
//                         style={{
//                           fontSize: 12,
//                           color: passwordRequirements.number(password)
//                             ? "#16a34a"
//                             : "#ef4444",
//                         }}
//                       >
...
//                         style={{
//                           fontSize: 12,
//                           color: passwordRequirements.uppercase(password)
//                             ? "#16a34a"
//                             : "#ef4444",
//                         }}
//                       >
...
//                         style={{
//                           fontSize: 12,
//                           color: passwordRequirements.special(password)
//                             ? "#16a34a"
//                             : "#ef4444",
//                         }}
//                       >
...
//                 {error_message ? (
//                   <Text sx={{ fontSize: 14, color: "#ef4444", mt: 8 }}>
//                     {error_message}
//                   </Text>
//                 ) : null}

//                 {info_message ? (
//                   <Text sx={{ fontSize: 14, color: "#16a34a", mt: 8 }}>
//                     {info_message}
//                   </Text>
//                 ) : null}
...
//         otpCode={otpCode}
//         setOtpCode={(v: string) => setOtpCode(v.replace(/\D/g, "").slice(0, 6))}
//         serverOtp={""}
//         otpInfo={otpInfo || "Enter the 6-digit code."}
//         otpError={otpError}
//         canResend={true}
//         canResendAt={0}
