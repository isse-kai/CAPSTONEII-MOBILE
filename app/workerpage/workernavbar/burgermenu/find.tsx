      ...
      <ScrollView>
        <View sx={{ p: 16 }}>
          ...
          >
            ...
            <Text sx={{ fontSize: 14, color: '#4b5563' }}>Client: Juan Dela Cruz</Text>
            <Pressable onPress={() => console.log('Apply for job: Fix Electrical Wiring')}>
              <Text sx={{ fontSize: 14, color: '#008CFC', mt: 8 }}>Apply Now</Text>
            </Pressable>
          </View>
        </View>
      </ScrollView>
