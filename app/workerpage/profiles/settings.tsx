        ...
        >
          ...
          >
            ...
            <View style={{ backgroundColor: '#ffffffcc', borderRadius: 12, padding: 16, marginBottom: 20 }}>
              <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  <Ionicons name="person-outline" size={22} color="#374151" style={{ marginRight: 8 }} />
              ...
              <View style={{ marginBottom: 12 }}>
                <Text sx={{ fontSize: 14, fontFamily: 'Poppins-Bold', mb: 2 }}>ACCOUNT CREATED</Text>
            ...
            <View style={{ backgroundColor: '#ffffffcc', borderRadius: 12, padding: 16, marginBottom: 20 }}>
              ...
              {/* First Name */}
              <View style={{ marginBottom: 12 }}>
                <Text sx={{ fontSize: 12, fontFamily: 'Poppins-Bold', mb: 4 }}>FIRST NAME:</Text>
                <TextInput value={user?.user_metadata?.first_name || 'N/A'} editable={false} style={{
                  borderWidth: 1, borderColor: '#d1d5db', borderRadius: 8, paddingHorizontal: 10,
                  fontSize: 14, fontFamily: 'Poppins-Regular', backgroundColor: '#f9fafb', color: '#374151',
                }} />
              </View>
              {/* Last Name */}
              <View style={{ marginBottom: 12 }}>
                <Text sx={{ fontSize: 12, fontFamily: 'Poppins-Bold', mb: 4 }}>LAST NAME:</Text>
                <TextInput value={user?.user_metadata?.last_name || 'N/A'} editable={false} style={{
                  borderWidth: 1, borderColor: '#d1d5db', borderRadius: 8, paddingHorizontal: 10,
                  fontSize: 14, fontFamily: 'Poppins-Regular', backgroundColor: '#f9fafb', color: '#374151',
                }} />
              </View>
              {/* Email */}
              <View style={{ marginBottom: 12 }}>
                <Text sx={{ fontSize: 12, fontFamily: 'Poppins-Bold', mb: 4 }}>EMAIL:</Text>
                <TextInput value={user?.email || 'N/A'} editable={false} style={{
                  borderWidth: 1, borderColor: '#d1d5db', borderRadius: 8, paddingHorizontal: 10,
                  fontSize: 14, fontFamily: 'Poppins-Regular', backgroundColor: '#f9fafb', color: '#374151',
                }} />
              </View>
              ...
              <View style={{ marginBottom: 12 }}>
                ...
                <TextInput value={user?.user_metadata?.age?.toString() || 'N/A'} editable={false} style={{
                  borderWidth: 1, borderColor: '#d1d5db', borderRadius: 8, paddingHorizontal: 10,
                  fontSize: 14, fontFamily: 'Poppins-Regular', backgroundColor: '#f9fafb', color: '#374151',
                }} />
              </View>
              {/* Contact Number */}
              <View style={{ marginBottom: 12 }}>
                <Text sx={{ fontSize: 12, fontFamily: 'Poppins-Bold', mb: 4 }}>CONTACT NUMBER:</Text>
                <View style={{
                  flexDirection: 'row', alignItems: 'center',
                  borderWidth: 1, borderColor: '#d1d5db', borderRadius: 8, overflow: 'hidden',
                }}>
                  <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, backgroundColor: '#f9fafb' }}>
                    <Text sx={{ fontSize: 14, fontFamily: 'Poppins-Regular' }}>🇵🇭 +63</Text>
                    <View style={{ width: 1, height: '100%', backgroundColor: '#d1d5db', marginLeft: 8 }} />
                  </View>
                  <TextInput defaultValue={user?.user_metadata?.contact_number || ''} placeholder="Enter contact number" keyboardType="number-pad" style={{
                    flex: 1, paddingHorizontal: 10, fontSize: 14, fontFamily: 'Poppins-Regular',
                  }} />
                </View>
              </View>
            ...
            <View style={{ backgroundColor: '#ffffffcc', borderRadius: 12, padding: 16, marginBottom: 20 }}>
              <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 12 }}>
                <Ionicons name="shield-checkmark-outline" size={22} color="#374151" style={{ marginRight: 8 }} />
                <Text sx={{ fontSize: 18, fontFamily: 'Poppins-Bold' }}>Security</Text>
              </View>

              {/* Current Password */}
              <View style={{ marginBottom: 12 }}>
                <Text sx={{ fontSize: 12, fontFamily: 'Poppins-Bold', mb: 4 }}>CURRENT PASSWORD:</Text>
                <View style={{
                  flexDirection: 'row',
                  alignItems: 'center',
                  borderWidth: 1,
              ...
              {/* New Password */}
              <View style={{ marginBottom: 12 }}>
                <Text sx={{ fontSize: 12, fontFamily: 'Poppins-Bold', mb: 4 }}>NEW PASSWORD:</Text>
                <View style={{
                  flexDirection: 'row',
                  alignItems: 'center',
                  borderWidth: 1,
              ...
              <View style={{ marginBottom: 12 }}>
                <Text sx={{ fontSize: 12, fontFamily: 'Poppins-Bold', mb: 4 }}>CONFIRM NEW PASSWORD:</Text>
                <View style={{
                  flexDirection: 'row',
                  alignItems: 'center',
                  borderWidth: 1,
