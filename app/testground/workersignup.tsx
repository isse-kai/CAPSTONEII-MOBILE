...
//     setTimeout(() => {
//       setIsLoading(false)
//       Alert.alert('Success', `Worker account created for ${fullName}`)
//       router.push('/')
//     }, 2000)
//   }
...
//   const isFormValid = fullName && email && password && confirmPassword && phoneNumber && password === confirmPassword
...
//               <Pressable onPress={() => router.back()} sx={{ width: 44, height: 44, borderRadius: 22, justifyContent: 'center', alignItems: 'center' }}
...
//           {/* Title */}
//           <View sx={{ flex: 1, px: 'lg', mx: 'md', alignItems: 'center' }}>
...
//               </View>
//               <Text sx={{ fontSize: 22, fontFamily: 'Poppins-ExtraBold', color: '#001a33', mb: 'xs', textAlign: 'center' }}>Join as Worker</Text>
...
//             {/* Form */}
//             <View sx={{ borderRadius: 14, p: 'lg', mb: 'lg', width: '100%' }}>
//               {['Full Name', 'Email Address', 'Phone Number', 'Password', 'Confirm Password'].map((label, i) => {
...
//                   case 'Phone Number': value=phoneNumber; setter=setPhoneNumber; placeholder='Your contact number'; keyboardType='phone-pad'; autoComplete='tel'; break;
...
//                       style={{ height: 46, paddingHorizontal: 15, borderRadius: 12, backgroundColor: 'transparent', fontSize: 14, borderWidth: 2, borderColor: value ? '#0685f4' : '#e4e7ec', color: '#001a33', fontFamily: 'Poppins-Regular' }}
...
//             {/* Footer */}
//             <View sx={{ px: 'lg', pb: 'lg', alignItems: 'center' }}>
