...
const NOTIF_KEY = "notifications_local"; // ✅ change if you use another key
...
const ClientHeader = () => {
  ...
  // ✅ Load notifications locally when dropdown opens
  useEffect(() => {
    ...
    const fetchNotifications = async () => {
      try {
        ...
        setNotifications(Array.isArray(list) ? list.slice(0, 3) : []);
      } catch (e) {
      ...
      <AnimatePresence>
        {notificationsOpen && (
          ...
          >
            ...
            <Pressable
              onPress={() =>
                router.push("/clientpage/clientnavbar/notifications")
              }
            >
              <Text
                sx={{
      ...
      <AnimatePresence>
        {menuOpen && (
          ...
          >
            ...
            {submenuOpen && (
              <View sx={{ pl: 12, gap: 8, mt: 8 }}>
                <Pressable
                  onPress={() =>
                    router.replace(
                      "./clientpage/clientnavbar/burgermenu/request",
                    )
                  }
                >
                  <Text
                ...
                <Pressable
                  onPress={() =>
                    router.replace(
                      "/clientpage/clientnavbar/burgermenu/completed",
                    )
                  }
                >
                  <Text
            ...
            <Pressable
              onPress={() =>
                router.replace("/clientpage/clientnavbar/burgermenu/hire")
              }
            >
              <Text
                sx={{
